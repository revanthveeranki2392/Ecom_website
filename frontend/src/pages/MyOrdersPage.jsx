...
const MyOrdersPage = () => {
    ...
    useEffect(() => {
        //stimulate the fetching of orders
        setTimeout(() => {
            const mockOrders = [
                {
                    _id: "12345",
                    ...
                    orderItems: [
                        {
                            name : "product 1",
                            image: "https://picsum.photos/500/500?random=67",
                        },
                    ],
                    totalPrice: 100,
                    isPaid: true,
                },
                {
                    ...
                    orderItems: [
                        {
                            name : "product 2",
                            image: "https://picsum.photos/500/500?random=97",
                        },
                    ],
                    totalPrice: 100,
                    isPaid: true,
            ...
            <table className="min-w-full text-left text-gray-500">
                ...
                <tbody>
                    {orders.length >0 ? (
                        ...
                        <tr>
                            <td colSpan="7" className="text-center py-4 px-4 text-gray-500">You have no orders</td>
                        </tr>
                    )}
                </tbody>
