...
const cart = {
    products: [
        ...
        },
        {
            ...
            color: "white",
            price: 75,
            image: "https://picsum.photos/500/500?random=89",
        },
    ],
    totalPrice: 195,
}
...
const Checkout = () => {
  ...
  return (
    <div className="grid grid-col-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto p-10 px-6 tracking-tighter">
        {/* Left Session */}
            ...
            <form onSubmit={handleCreateCheckout} >
                ...
                <div className="mb-4 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        setShippingAddress({...shippingAddress, firstName: e.target.value}) } className="w-full p-2 border rounded" required />
                    </div>
                    <div>
                        <label className="block text-gray-700">Last Name</label>
                        <input type="text" value={shippingAddress.lastName} onChange={(e) => 
                        setShippingAddress({...shippingAddress, lastName: e.target.value}) } className="w-full p-2 border rounded" required />
                    </div>
                ...
                <div>
                        ...
                        setShippingAddress({...shippingAddress, city: e.target.value}) } className="w-full p-2 border rounded" required />
                    </div>
                    <div>
                        <label className="block text-gray-700">Postal Code</label>
                        
                        <input type="text" value={shippingAddress.postalCode} onChange={(e) => 
                        setShippingAddress({...shippingAddress, postalCode: e.target.value}) } className="w-full p-2 border rounded" required />
                    </div>
                </div>
                <div className="mb-4">
